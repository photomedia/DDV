...
// Allowed hostname
//define ('HOSTNAME', 'http://www.ebi.ac.uk/soaplab/typed/services/nucleic_cpg_islands.geecee');
define ('HOSTNAME', 'http://wsembnet.vital-it.ch:80/soaplab2-axis/typed/services/nucleic_cpg_islands.geecee');
